...
func (s *statement) ExecuteQuery(ctx context.Context) (rdr array.RecordReader, nrec int64, err error) {
	...
	if s.prepared != nil {
		...
		return nil, -1, adbc.Error{
			Msg:  "[Bigquery Statement] cannot call ExecuteQuery without a query or prepared statement",
...
func (s *statement) ExecuteUpdate(ctx context.Context) (int64, error) {
	...
	return -1, adbc.Error{
		Msg:  "[Bigquery Statement] cannot call ExecuteUpdate without a query or prepared statement",
		Code: adbc.StatusInvalidState,
	}
}
...
func (s *statement) Prepare(ctx context.Context) error {
	if s.query == "" {
		return adbc.Error{
			Msg:  "[Bigquery Statement] must call SetSqlQuery before Prepare",
...
func (s *statement) SetSubstraitPlan(plan []byte) error {
	return adbc.Error{
		Msg:  "[Bigquery Statement] SetSubstraitPlan not implemented",
		Code: adbc.StatusNotImplemented,
	}
}
...
func (s *statement) Bind(_ context.Context, values arrow.Record) error {
	...
	if s.prepared == nil {
		return adbc.Error{
			Msg:  "[Bigquery Statement] must call Prepare before calling Bind",
			Code: adbc.StatusInvalidState}
	}
...
func (s *statement) BindStream(ctx context.Context, stream array.RecordReader) error {
	return adbc.Error{
		Msg:  "[Bigquery Statement] BindStream not yet implemented",
		Code: adbc.StatusNotImplemented,
	}
}
...
func (s *statement) GetParameterSchema() (*arrow.Schema, error) {
	if s.prepared == nil {
		return nil, adbc.Error{
			Msg:  "[Bigquery Statement] must call Prepare before GetParameterSchema",
			Code: adbc.StatusInvalidState,
		}
	}
